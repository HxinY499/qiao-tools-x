// Notion Style Dark 主题 - 来自 Typora (https://theme.typora.io/theme/Notion-Style/)
// 精确复刻 Notion 美学的简洁现代暗色主题
export const style = `
.markdown-body {
...
.markdown-body .highlight-brown {
  background-color: rgba(140, 46, 0, 0.3);
}

.markdown-body .highlight-orange {
  background-color: rgba(245, 93, 0, 0.3);
}

.markdown-body .highlight-yellow {
  background-color: rgba(233, 168, 0, 0.3);
}

.markdown-body .highlight-green {
  background-color: rgba(0, 135, 107, 0.3);
}

.markdown-body .highlight-blue {
  background-color: rgba(0, 120, 223, 0.3);
}

.markdown-body .highlight-purple {
  background-color: rgba(103, 36, 222, 0.3);
}

.markdown-body .highlight-pink {
  background-color: rgba(221, 0, 129, 0.3);
}

.markdown-body .highlight-red {
  background-color: rgba(255, 0, 26, 0.3);
}
...
.markdown-body .callout-info {
  background-color: rgba(0, 120, 223, 0.15);
}

.markdown-body .callout-warning {
  background-color: rgba(233, 168, 0, 0.15);
}

.markdown-body .callout-danger {
  background-color: rgba(255, 0, 26, 0.15);
}

.markdown-body .callout-success {
  background-color: rgba(0, 135, 107, 0.15);
}
`;
